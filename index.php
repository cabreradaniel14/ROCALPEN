...
function Header()
{
    ...
    // Título
    $this->Cell(100,10,'Reporte de Prestacion de Ropa de Oficina Caballero',10,0,'C');
...
$fecha = date('l jS \of F Y h:i:s A');
 ...
 $consulta = "SELECT * FROM ropa_hombre_ofic";
