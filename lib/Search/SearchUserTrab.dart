...
import 'package:app_requisicion/Search/EditUserHomTrab.dart';
...
class SearUserTrabajador2 extends SearchDelegate<String>{
                ...
                return Card(
                  child: ListTile(
                    ...
                    onTap: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(builder: (context) => EditUserHombTrabajador(student: data)),
                      );
                    },
                  ),
                );
