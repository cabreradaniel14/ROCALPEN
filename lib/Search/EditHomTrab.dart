...
class EditHombTrabajador extends StatefulWidget {
  final Student student;

  EditHombTrabajador({this.student});

  @override
  _EditHombTrabajadorState createState() => _EditHombTrabajadorState();
}

class _EditHombTrabajadorState extends State<EditHombTrabajador> {
