...
class ListarTrabajador extends StatefulWidget {
  const ListarTrabajador({ Key key }) : super(key: key);

  ListarTrabajador.builder({itemCount, Card Function(BuildContext context, int index) itemBuilder});

  @override
  _ListarTrabajadorState createState() => _ListarTrabajadorState();
}

class _ListarTrabajadorState extends State<ListarTrabajador> {
  
  Future<List<Student>> students;
  final studentListKey = GlobalKey<_ListarTrabajadorState>();
   ...
   return Scaffold(
      ...
      appBar: AppBar(
        ...
        actions: [
          ...
          onPressed: (){
            showSearch(context: context, delegate: SearUserTrabajador());
          },
