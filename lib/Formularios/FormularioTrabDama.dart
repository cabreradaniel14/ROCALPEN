...
class FormularioTrabajoDama extends StatefulWidget {
  
  const FormularioTrabajoDama({Key key}) : super(key: key);

  @override
  State<FormularioTrabajoDama> createState() => _FormularioTrabajoDamaState();
}

class _FormularioTrabajoDamaState extends State<FormularioTrabajoDama> {
...
Future addReport()async{
      ...
      var response = await http.post(Uri.parse('http://10.17.1.99:8080//ropa/AddDataFormDamaCampo.php'), body: data);
  ...
  List<Map> _myJson2 = [{"id":0,"pantalon":"26"},{"id":1, "pantalon":"27"},{"id":2, "pantalon": "28"},{"id":3, "pantalon": "29"},{"id":4, "pantalon": "30"},{"id":5, "pantalon": "31"},{"id":6, "pantalon": "32"},{"id":7, "pantalon": "33"},{"id":8, "pantalon": "34"},{"id":9, "pantalon": "35"},{"id":10, "pantalon": "37"},{"id":11, "pantalon": "38"},{"id":12, "pantalon": "39"},{"id":13, "pantalon": "40"},{"id":14, "pantalon": "41"},{"id":15, "pantalon": "42"},{"id":16, "pantalon": "43"},{"id":17, "pantalon": "44"},{"id":18, "pantalon": "45"},{"id":19, "pantalon": "46"},{"id":20, "pantalon": "47"},{"id":21, "pantalon": "48"},{"id":22, "pantalon": "49"},{"id":23, "pantalon": "50"},{"id":24, "pantalon": "51"},{"id":25, "pantalon": "52"},{"id":26, "pantalon": "53"},{"id":27, "pantalon": "54"},{"id":28, "pantalon": "55"},{"id":29, "pantalon": "56"}];

  String _mySelection3; 
  List<Map> _myJson3 = [{"id":0,"largo":"26"},{"id":1, "largo":"27"},{"id":2, "largo": "28"},{"id":3, "largo": "29"},{"id":4, "largo": "30"},{"id":5, "largo": "31"},{"id":6, "largo": "32"},{"id":7, "largo": "33"},{"id":8, "largo": "34"},{"id":9, "largo": "35"},{"id":10, "largo": "37"},{"id":11, "largo": "38"},{"id":12, "largo": "39"},{"id":13, "largo": "40"},];
          ...
          child: SingleChildScrollView(
              ...
              child: Column(
                ...
                children: [
                  ...
                  child: Image.asset('assets/image/liniera2.png')
                  ),
                  SizedBox(height: 10,),
                  Text(
                    'Formulario de Prestación de Ropa de Trabajo Dama',
                    style: TextStyle(
                      ...
                      children:<Widget> [
                        ...
                        Center(
                          ...
                          child: new DropdownButton<String>(
                                isDense: false,
                                hint: Center(child: new Text("Talla de camisola",style: TextStyle(color:Colors.white))),
...
page.graphics.drawString(
  ...
  saveAndLaunchFile(bytes, rpe.text+'.pdf');
