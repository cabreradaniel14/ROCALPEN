...
class EditFormDamaOficina2 extends StatefulWidget {
  final List notas;
  final int index;

  EditFormDamaOficina2({this.notas ,this.index});

  @override
  _EditFormDamaOficina2State  createState() => new _EditFormDamaOficina2State();
}

class _EditFormDamaOficina2State extends State<EditFormDamaOficina2> {
  ...
  @override
    void initState() {
      ...
      controllerblusa= new TextEditingController(text: widget.notas[widget.index]['blusa'] );
      controllercadera= new TextEditingController(text: widget.notas[widget.index]['cadera'] );
      controllercintura= new TextEditingController(text: widget.notas[widget.index]['cintura'] );
      controllerfalda= new TextEditingController(text: widget.notas[widget.index]['falda'] );
      ...
      controllercalzado= new TextEditingController(text: widget.notas[widget.index]['calzado'] );
