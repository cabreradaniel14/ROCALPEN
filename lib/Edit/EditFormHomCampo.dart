...
class EditFormHombreCampo extends StatefulWidget {
  final List list;
  final int index;

  EditFormHombreCampo({this.list, this.index});

  @override
  _EditFormHombreCampoState  createState() => new _EditFormHombreCampoState();
}

class _EditFormHombreCampoState extends State<EditFormHombreCampo> {
  ...
  void editData() {
     ...
     var url ="http://10.17.1.99:8080/ropa/EditDataFormHomCampo.php";
                 ...
                 new ListTile(
                  ...
                  new ListTile(
                    ...
                    title: new TextFormField(
                      ...
                      textCapitalization: TextCapitalization.characters,
                          validator: (value) {
                            if (value.isEmpty) return "camisola ";
                          },
                      decoration: new InputDecoration(
                  ...
                  new ListTile(
                    ...
                    title: new TextFormField(
                      ...
                      textCapitalization: TextCapitalization.characters,
                          // ignore: missing_return
                          validator: (value) {
                            if (value.isEmpty) return "Tipo de bota";
                          },
                      decoration: new InputDecoration(
                        hintText: "Tipo de Bota", labelText: "Tipo de Bota: ",
                      ),
                    ),
                  ),
                  new ListTile(
                    ...
                    title: new TextFormField(
                      ...
                      textCapitalization: TextCapitalization.characters,
                          // ignore: missing_return
                          validator: (value) {
                            if (value.isEmpty) return "tallabota";
                          },
                      decoration: new InputDecoration(
                        hintText: "Talla Bota", labelText: "Talla: ",
                      ),
                    ),
                  ),
