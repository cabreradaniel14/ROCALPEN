...
class EditFormHombreOficina extends StatefulWidget {
  final List list;
  final int index;

  EditFormHombreOficina({this.list, this.index});

  @override
  _EditFormHombreOficinaState  createState() => new _EditFormHombreOficinaState();
}

class _EditFormHombreOficinaState extends State<EditFormHombreOficina> {
  ...
  @override
    void initState() {
      ...
      controllercamisa= new TextEditingController(text: widget.list[widget.index]['camisa'] );
      ...
      controllerzapato= new TextEditingController(text: widget.list[widget.index]['zapato'] );
