...
import 'package:app_requisicion/SearchDamaTrabajo/EditUserDamaTrab.dart';
...
class ListarUserDamaTrabajador extends StatefulWidget {
  const ListarUserDamaTrabajador({ Key key }) : super(key: key);

  ListarUserDamaTrabajador.builder({itemCount, Card Function(BuildContext context, int index) itemBuilder});

  @override
  _ListarUserDamaTrabajadorState createState() => _ListarUserDamaTrabajadorState();
}

class _ListarUserDamaTrabajadorState extends State<ListarUserDamaTrabajador> {
  
  Future<List<Student>> students;
  final studentListKey = GlobalKey<_ListarUserDamaTrabajadorState>();
   ...
   return Scaffold(
      ...
      appBar: AppBar(
        ...
        actions: [
          ...
          onPressed: (){
            showSearch(context: context, delegate: SearUserTrabajadora2());
          },
                ...
                return Card(
                  child: ListTile(
                    ...
                    onTap: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(builder: (context) => EditUserDamaTrabajador(student: data)),
                      );
                    },
                  ),
                );
...
class Env {
  static String URL_PREFIX = "http://10.17.1.99:8080//ropa/GetDataDamaCampo.php";
}
