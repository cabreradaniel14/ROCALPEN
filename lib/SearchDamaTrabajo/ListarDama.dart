...
import 'package:app_requisicion/SearchDamaTrabajo/SearchDamaTrabajador.dart';

import 'package:flutter/material.dart';
import 'package:http/http.dart' as http;

class ListarDamaTrabajador extends StatefulWidget {
  const ListarDamaTrabajador({ Key key }) : super(key: key);

  ListarDamaTrabajador.builder({itemCount, Card Function(BuildContext context, int index) itemBuilder});

  @override
  _ListarDamaTrabajadorState createState() => _ListarDamaTrabajadorState();
}

class _ListarDamaTrabajadorState extends State<ListarDamaTrabajador> {
  
  Future<List<Student>> students;
  final studentListKey = GlobalKey<_ListarDamaTrabajadorState>();
   ...
   return Scaffold(
      ...
      appBar: AppBar(
        ...
        actions: [
          ...
          onPressed: (){
            showSearch(context: context, delegate: SearUserTrabajadora());
          },
