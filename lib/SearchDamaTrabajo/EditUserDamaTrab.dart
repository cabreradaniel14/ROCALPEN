...
import 'package:app_requisicion/SearchDamaTrabajo/ListarUserDama.dart';
...
class EditUserDamaTrabajador extends StatefulWidget {
  final Student student;

  EditUserDamaTrabajador({this.student});

  @override
  _EditUserDamaTrabajadorState createState() => _EditUserDamaTrabajadorState();
}

class _EditUserDamaTrabajadorState extends State<EditUserDamaTrabajador> {
