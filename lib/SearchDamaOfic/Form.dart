...
class AppForm extends StatefulWidget {
  ...
  AppForm({this.formKey, this.rpeController, this.nombreController,this.zonaController,this.departamentoController,this.categoriaController,this.blusaController,this.pantalonController,this.largoController,this.tipobotaController,this.tallabotaController,this.observController});
      ...
      child: Form(
        ...
        child: Column(
          children: <Widget>[
            ...
            TextFormField(
              controller: widget.blusaController,
              keyboardType: TextInputType.number,
