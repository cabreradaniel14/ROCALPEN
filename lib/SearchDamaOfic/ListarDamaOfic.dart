...
import 'package:app_requisicion/SearchDamaOfic/DetailsDamaOfic.dart';
import 'package:app_requisicion/SearchDamaOfic/SearchDamaOfic.dart';
import 'package:flutter/material.dart';
import 'package:http/http.dart' as http;

class ListarDamaOfic extends StatefulWidget {
  const ListarDamaOfic({ Key key }) : super(key: key);

  ListarDamaOfic.builder({itemCount, Card Function(BuildContext context, int index) itemBuilder});

  @override
  _ListarDamaOficState createState() => _ListarDamaOficState();
}

class _ListarDamaOficState extends State<ListarDamaOfic> {
  
  Future<List<Student>> students;
  final studentListKey = GlobalKey<_ListarDamaOficState>();
   ...
   return Scaffold(
      ...
      appBar: AppBar(
        ...
        actions: [
          ...
          onPressed: (){
            showSearch(context: context, delegate: SearUserDamaOfic());
          },
                ...
                return Card(
                  child: ListTile(
                    ...
                    onTap: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(builder: (context) => DetailsDamaOfic(student: data)),
                      );
                    },
                  ),
                );
