...
import 'package:app_requisicion/SearchDamaOfic/ListarUserDamaOf.dart';
...
class EditUserDamaOfic extends StatefulWidget {
  final Student student;

  EditUserDamaOfic({this.student});

  @override
  _EditUserDamaOficState createState() => _EditUserDamaOficState();
}

class _EditUserDamaOficState extends State<EditUserDamaOfic> {
  ...
  TextEditingController blusaController;
...
List<Map> _myJson6 = [{"id":0,"cintura":"26"},{"id":1, "cintura":"28"},{"id":2, "cintura": "30"},{"id":3, "cintura": "32"},{"id":4, "cintura": "34"},{"id":5, "cintura": "36"},{"id":6, "cintura": "38"},{"id":7, "cintura": "40"},{"id":8, "cintura": "42"},{"id":9, "cintura": "44"},{"id":10, "cintura": "46"},{"id":11, "cintura": "48"}];
  ...
  void initState() {
    ...
    blusaController = TextEditingController(text: widget.student.blusa);
                   ...
                   children: <Widget>[
                     ...
                     Expanded(
                        ...
                        child: new DropdownButton<String>(
                              isDense: true,
                              hint: new Text(widget.student.blusa),
                              iconSize: 40.0,
                              elevation: 10,
                              value: _mySelection,
                  ...
                  Row(
                   children: <Widget>[
                     ...
                     Expanded(
                        ...
                        child: new DropdownButton<String>(
                              isDense: true,
                              hint: new Text(widget.student.cintura),
                              iconSize: 40.0,
                              elevation: 10,
                              value: _mySelection6,
                              onChanged: (String newValue) {
                 ...
                 Row(
                   children: <Widget>[
                     ...
                     Expanded(
                        ...
                        child: new DropdownButton<String>(
                              isDense: true,
                              hint: new Text(widget.student.falda),
                              iconSize: 40.0,
                              elevation: 10,
                              value: _mySelection2,
                              onChanged: (String newValue) {
                  ...
                  Row(
                   children: <Widget>[
                     ...
                     Expanded(
                        ...
                        child: new DropdownButton<String>(
                              isDense: true,
                              hint: new Text(widget.student.calzado),
                              iconSize: 40.0,
                              elevation: 10,
                              value: _mySelection5,
                              onChanged: (String newValue) {
...
headerRow.cells[3].value = 'Largo de pantalón';
headerRow.cells[4].value = 'Largo de falda';
headerRow.cells[5].value = 'Talla de calzado';
...
row.cells[2].value = _mySelection6;
row.cells[3].value = _mySelection3;
row.cells[4].value = _mySelection2;
