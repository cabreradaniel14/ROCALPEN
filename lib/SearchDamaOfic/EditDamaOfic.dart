...
class EditDamaOfic extends StatefulWidget {
  final Student student;

  EditDamaOfic({this.student});

  @override
  _EditDamaOficState createState() => _EditDamaOficState();
}

class _EditDamaOficState extends State<EditDamaOfic> {
