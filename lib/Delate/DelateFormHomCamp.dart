...
class DetailHombCamp extends StatefulWidget {
  List list;
  int index;
  DetailHombCamp({this.index, this.list});
  @override
  _DetailHombCampState createState() => new _DetailHombCampState();
}

class _DetailHombCampState extends State<DetailHombCamp> {
  void deleteData() {
    var url = "http://10.17.1.99:8080/ropa/DelateFormHomCamp.php";
