...
import 'package:app_requisicion/Listar/Details.dart';
...
class ListViewData extends StatefulWidget {
  ...
  ListViewData.builder({itemCount, Card Function(BuildContext context, int index) itemBuilder});
...
class _ListViewDataState extends State<ListViewData> {
  ...
  final studentListKey = GlobalKey<_ListViewDataState>();
