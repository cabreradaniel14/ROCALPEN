...
<div class="fondo">
    ...
    if (isset($_GET['enviar'])){
        ...
        $consulta = $connect->query("SELECT COUNT(*) as talla_bota, tipo_bota FROM ropa_dama_campo WHERE talla_bota = '$busqueda' GROUP BY tipo_bota");
  ...
  <tbody>
    <tr>
    <td><?php echo $row['tipo_bota'].'<br>'; ?></td> 
    <td><?php echo $row['talla_bota'].'<br>'; ?></td>  
